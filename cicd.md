...
1. 新建Item
![img](./cicd/jenkins-1.jpg)
2. 填写项目名称，选择项目类型
![img](./cicd/jenkins-2.jpg)
3. 填写项目详需信息
![img](./cicd/jenkins-3.jpg)
git 地址 https://github.com/jiam/Simplest-Spring-Boot-Hello-World.git
![img](./cicd/jenkins-4.jpg)
配置maven
![img](./cicd/jenkins-5.jpg)
![img](./cicd/jenkins-6.jpg)
![img](./cicd/jenkins-7.jpg)
![img](./cicd/jenkins-8.jpg)
点击保存

在项目配置页面点击保存

4. 开始构建
![img](./cicd/jenkins-9.jpg)

5. 查看构建日志
![img](./cicd/jenkins-10.jpg)
![img](./cicd/jenkins-11.jpg)
返回工程
6. 查看构建产物
![img](./cicd/jenkins-12.jpg)
...
![img](./cicd/jenkins-20.jpg)
![img](./cicd/jenkins-22.jpg)

5. 参数话构建
![img](./cicd/jenkins-23.jpg)
